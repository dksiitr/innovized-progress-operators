...
class Algorithm:
    ...
    def setup(self,
        ...
        self.co_frequency = co_frequency
        self.do_frequency = do_frequency
        self.co_boost = co_boost
        self.co_repair_fraction = co_repair_fraction
        self.do_repair_fraction = do_repair_fraction
        self.cone_dom_alpha = cone_dom_alpha
        # if self.learn and learn_method is None:
        #     raise NameError('No learning method selected')
        # elif self.learn:
        #     self.learn_method = learn_method
